...
@export var ignore_empty_terrains := true
@export var terrain_type := Enums.TerrainType.PATH;
@export var raw_middle_terrain_set := -1;
@export var raw_middle_terrain := -1;
@export var raw_bottom_terrain_set := -1;
@export var raw_bottom_terrain := -1;
...
func _init(_terrain_set := 0, _terrain := 0, _ignore_empty_terrains := true, _terrain_type := Enums.TerrainType.PATH, _middle_terrain_set := -1, _middle_terrain := -1, _bottom_terrain_set := -1, _bottom_terrain := -1) -> void:
